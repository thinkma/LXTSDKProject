#
#  Be sure to run `pod spec lint LXTSDKProject.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.version      = "0.0.1"
  s.summary      = "MicroLanguage SDK description."
  ...
  s.author             = { "apple" => "think_am@126.com" }
  # Or just: s.author    = "apple"
  # s.authors            = { "apple" => "think_am@126.com" }
